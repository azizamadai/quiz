...
#print("-------------------------------------------------------------------")
print(" ")
print("You got a...", score * 10, "% on this quiz!")
print(" ")
...
if score * 10 == 0:
    print("Yikes...you didn't get anything right. I'm sorry, maybe you should study more?")

print("Thank you for taking my quiz! I hope you liked it.")
